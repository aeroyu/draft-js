...
var DraftEditorCompositionHandler = {
  ...
  resolveComposition: function resolveComposition(editor) {
    ...
    mutations.forEach(function (composedChars, offsetKey) {
      ...
      if (!replaced) {
        console.log('DraftEditorCompositionHandler', replacementRange, composedChars, entityKey, currentStyle);
    ...
    anchorKey === focusKey && !isSelectionCrossBlock ? editor.restoreBlockDOM(anchorKey) : editor.restoreEditorDOM();
